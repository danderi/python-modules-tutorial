...
¡Comencemos con algo sencillo! Importaremos el módulo `random` y lo usaremos para generar un número aleatorio.
...
¡Deberías ver un número aleatorio entre 1 y 10 impreso en la consola!
```python
