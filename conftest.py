...
def pytest_generate_tests(metafunc):
    ...
    if 'configuration' in metafunc.fixturenames:
        metafunc.parametrize("configuration", [json.loads('{"port":3000,"os":"win32","editor":{"mode":"extension","agent":"vscode","version":"5.0.69"},"dirPath":"./.learn","configPath":"learn.json","outputPath":".learn/dist","publicPath":"/preview","publicUrl":"http://localhost:3000","contact":"https://github.com/learnpack/learnpack/issues/new","language":"python3","autoPlay":true,"projectType":"tutorial","grading":"isolated","exercisesPath":"./exercises","webpackTemplate":null,"disableGrading":false,"disabledActions":[],"actions":[],"entries":{"html":"index.html","vanillajs":"index.js","react":"app.jsx","node":"app.js","python3":"app.py","java":"app.java"},"suggestions":{"agent":"vscode"},"warnings":{"agent":null},"slug":"python-modules-tutorial","title":"Learn Python Modules","repository":"https://github.com/learnpack/python-modules","preview":"https://github.com/learnpack/python-modules/blob/master/preview.gif?raw=true","description":"Learn how to use and create Python modules, from basic imports to advanced concepts","difficulty":"beginner","duration":6,"videoSolutions":false,"bugsLink":"https://github.com/learnpack/python-modules/issues/new","graded":true,"translations":[]}')])
